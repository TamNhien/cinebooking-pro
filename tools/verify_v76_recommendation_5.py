...
check('V76 E2E verifies version order through 76','sort((a,b)=>a-b)' in e2e and 'toBe(76)' in e2e and 'toContain(75)' in e2e)
...
check('CI source regression names V76','V26-V76 source regression' in ci)
...
check('Release example V76 stable','such as v76.0.0' in release)
...
check('README title V76',re.search(r'^# CineBooking Pro V76$',readme,re.M) is not None)
check('README current release V76','Current release:** V76 - Recommendation 5.0' in readme)
