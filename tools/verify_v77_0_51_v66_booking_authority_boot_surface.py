...
ok(any(x in sw for x in ['const VERSION = "v77-0-51";','const VERSION = "v77-0-52";','const VERSION = "v77-0-53";','const VERSION = "v77-0-54";','const VERSION = "v77-0-55";','const VERSION = "v77-0-56";','const VERSION = "v77-0-57";','const VERSION = "v77-0-59";','const VERSION = "v77-0-60";','const VERSION = "v77-0-61";']),
...
ok(any(x in prev for x in ['v77-0-51','v77-0-52','v77-0-53','v77-0-54','v77-0-55','v77-0-56']) and 'V77.0.50' in prev,
