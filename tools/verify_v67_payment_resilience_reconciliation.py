...
check('README current release is V67 or later',any(x in readme for x in ['Current release:** V67','Current release: **V67**','Current release:** V68','Current release: **V68**','Current release:** V69','Current release: **V69**']))
...
check('CI source regression names V67 or later',any(x in ci for x in ['V26-V67 source regression','V26-V68 source regression','V26-V69 source regression']))
...
check('Integration expects Flyway >=67',any(x in itest for x in ['isGreaterThanOrEqualTo(67)','isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)']))
check('Integration still expects at least 58 tables',any(x in itest for x in ['publicTables).isGreaterThanOrEqualTo(58)','publicTables).isGreaterThanOrEqualTo(59)','publicTables).isGreaterThanOrEqualTo(61)']))
...
check('V66 verifier forward-compatible with V67 integration expectation',any(x in text('tools/verify_v66_booking_consistency_seat_locking.py') for x in ['isGreaterThanOrEqualTo(67)','isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)']))
