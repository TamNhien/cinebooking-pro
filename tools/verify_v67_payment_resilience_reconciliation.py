...
check('README current release is V67','Current release:** V67' in readme or 'Current release: **V67**' in readme)
...
check('CI source regression names V67','V26-V67 source regression' in ci)
...
check('Integration expects Flyway >=67','isGreaterThanOrEqualTo(67)' in itest)
check('Integration still expects at least 58 tables','publicTables).isGreaterThanOrEqualTo(58)' in itest)
...
check('V66 verifier forward-compatible with V67 integration expectation','isGreaterThanOrEqualTo(67)' in text('tools/verify_v66_booking_consistency_seat_locking.py'))
...
check('README documents V67 release tags','v67.0.0-rc.1' in readme and 'v67.0.0' in readme)
