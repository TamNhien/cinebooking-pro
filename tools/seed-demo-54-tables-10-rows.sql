-- CineBooking realistic reference-data seed/repair for the 53 tables shown in pgAdmin (V49 schema).
-- Adds/repairs realistic deterministic rows in every V49 application table, EXCEPT movie.
...
-- Quick verification of all 54 tables shown in pgAdmin V50.
DO $$
DECLARE
    t TEXT;
    c BIGINT;
BEGIN
    FOREACH t IN ARRAY ARRAY[
        ...
        'cinema_concession_inventory','cinema_concession_price','concession_product','customer_support_case','customer_support_case_event',
        ...
        'payment_webhook_event','pricing_rule','recommendation_event','recommendation_feedback','seat','showtime',
