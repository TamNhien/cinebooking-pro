...
check('Integration test expects Flyway V50 and recommendation_feedback schema', 'flywayMigratesRealPostgresToV50RecommendationIntelligenceSchemaAndCatalog' in integration and 'assertThat(latest).isEqualTo("50")' in integration and 'recommendation_feedback' in integration)
check('Main CI includes V50 source and 54-table gates', 'V26-V50 source regression' in ci and 'verify_v50_recommendation_intelligence_2.py' in ci and 'verify_seed_demo_54.py' in ci)
check('Standalone RC defaults to V50 and keeps V50 gate', 'v50.0.0-rc.1' in rc and 'cinebooking_v50_rc_' in rc and 'verify_v50_recommendation_intelligence_2.py' in rc)
check('Stable release defaults to 50.0.0 and keeps V50 gate', 'default: "50.0.0"' in release and 'cinebooking_v50_release_' in release and 'verify_v50_recommendation_intelligence_2.py' in release)
