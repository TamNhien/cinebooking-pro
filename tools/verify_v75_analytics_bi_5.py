...
# E2E
check('V75 E2E logs in real admin env',('E2E_ADMIN_EMAIL' in e2e and 'E2E_ADMIN_PASSWORD' in e2e) or 'loginExistingAdmin(page)' in e2e)
...
check('V75 E2E verifies real data policy','REAL_OPERATIONAL_DATA_ONLY' in e2e or 'data-policy-real-operational' in e2e)
check('V75 E2E verifies no synthetic funnel','NO_SYNTHETIC_FUNNEL_EVENTS' in e2e or 'data-policy-no-synthetic-funnel' in e2e)
