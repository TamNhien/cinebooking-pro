...
docker compose exec backend-1 printenv MAIL_ENABLED ADMIN_EMAIL STAFF_TIME_ZONE TICKET_PUBLIC_BASE_URL

Write-Host ""
Write-Host "=== Next step ===" -ForegroundColor Cyan
Write-Host "Run: powershell -ExecutionPolicy Bypass -File .\tools\test-v11.ps1"
Write-Host "The V11 smoke test asks for the CURRENT Admin password with SecureString."
