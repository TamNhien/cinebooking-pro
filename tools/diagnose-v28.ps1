...
Write-Host "=== CineBooking V28.3 CI/Testcontainers diagnostics ==="
...
Write-Host ""
Write-Host "V28.3 DIAGNOSTICS PASSED"
Write-Host "Local .env and backups/*.dump are allowed; they must remain untracked by Git."
Write-Host "Next: git add -A, commit/push V28.3, then watch the 'CineBooking CI' workflow."
