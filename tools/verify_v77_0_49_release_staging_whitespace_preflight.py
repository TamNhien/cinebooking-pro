...
ok('const VERSION = "v77-0-49";' in sw, 'Service Worker release metadata advances to V77.0.49')
...
ok('Current release:** V77.0.49' in readme and '`v77.0.49`' in readme, 'README records V77.0.49 as the stable target')
ok([p.name for p in ROOT.glob('*.md')]==['README.md'], 'Source keeps one consolidated root Markdown history document')
ok('v77-0-49' in prev and 'V77.0.49' in prev, 'V77.0.48 verifier is forward-compatible with V77.0.49 release metadata')
ok('Current release:** V77.0.49' in v29 and '`v77.0.49`' in v29, 'V77.0.29 forward-compatibility chain accepts the V77.0.49 stable target')
