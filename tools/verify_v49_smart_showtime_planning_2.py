...
check('V49 E2E pins migration-backed cinema and movie instead of order-sensitive first options', 'selectOption({label:"CineHub Quận 1"})' in e2e and ('selectOption({label:"Hành Trình Sao Hỏa · 128 phút"})' in e2e or ('selectOptionContaining' in e2e and 'Hành Trình Sao Hỏa' in e2e)) and 'smart-cinema-select' in e2e and 'smart-movie-select' in e2e)
