...
check('Integration test expects Flyway V49 and 53 public tables', 'flywayMigratesRealPostgresToV49SmartShowtimePlanningSchemaAndCatalog' in integration and 'assertThat(latest).isEqualTo("49")' in integration and 'isGreaterThanOrEqualTo(53)' in integration)
...
check('Main CI includes V49 source and 53-table gates', 'V26-V49 source regression' in ci and 'verify_v49_smart_showtime_planning_2.py' in ci and 'verify_seed_demo_53.py' in ci)
check('Standalone RC defaults to V49 and keeps V49 gate', 'v49.0.0-rc.1' in rc and 'cinebooking_v49_rc_' in rc and 'verify_v49_smart_showtime_planning_2.py' in rc)
check('Stable release defaults to 49.0.0 and keeps V49 gate', 'default: "49.0.0"' in release and 'cinebooking_v49_release_' in release and 'verify_v49_smart_showtime_planning_2.py' in release)
