...
check('Main CI includes V49 source and 53-table gates', ('V26-V49 source regression' in ci or 'V26-V50 source regression' in ci) and 'verify_v49_smart_showtime_planning_2.py' in ci and 'verify_seed_demo_53.py' in ci)
check('Standalone RC defaults to V49 and keeps V49 gate', (('v49.0.0-rc.1' in rc and 'cinebooking_v49_rc_' in rc) or ('v50.0.0-rc.1' in rc and 'cinebooking_v50_rc_' in rc)) and 'verify_v49_smart_showtime_planning_2.py' in rc)
check('Stable release defaults to 49.0.0 and keeps V49 gate', (('default: "49.0.0"' in release and 'cinebooking_v49_release_' in release) or ('default: "50.0.0"' in release and 'cinebooking_v50_release_' in release)) and 'verify_v49_smart_showtime_planning_2.py' in release)
