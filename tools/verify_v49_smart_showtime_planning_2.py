...
check('V49 E2E avoids hardcoded room names by selecting real first options', 'selectOption({index:1})' in e2e and 'smart-cinema-select' in e2e and 'smart-movie-select' in e2e)
