...
ok('const VERSION = "v77-0-53";' in sw,
   'Service Worker release metadata advances to V77.0.53')
...
ok('Current release:** V77.0.53' in readme and '`v77.0.53`' in readme,
   'README records V77.0.53 as the stable target')
...
ok('v77-0-53' in prev or 'V77.0.53' in prev,
   'V77.0.52 verifier is forward-compatible with V77.0.53 release metadata')
ok('Current release:** V77.0.53' in v29 and '`v77.0.53`' in v29,
