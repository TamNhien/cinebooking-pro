...
check('Protected action groups raised to eleven','PROTECTED_ACTION_GROUPS=11' in stepup_service)
...
check('Integration expects Flyway >=71','isGreaterThanOrEqualTo(71)' in itest)
check('Integration expects at least 65 public tables','publicTables).isGreaterThanOrEqualTo(65)' in itest)
...
check('V70 verifier forward-compatible with V71','71' in v70verify and '65' in v70verify)
check('V69 verifier forward-compatible with V71','71' in v69verify and '65' in v69verify)
check('V68 verifier forward-compatible with V71','71' in v68verify and '65' in v68verify)
check('V71 adds no synthetic seeded business rows','V71' not in seed)

# CI/tooling/docs/release
check('CI source regression names V71','V26-V71 source regression' in ci)
...
check('Release example is V71 stable','such as v71.0.0' in release)
check('Release remains stable-only','Pre-release tags are disabled' in release and '-rc.' not in release)
check('README current release V71','Current release:** V71' in readme or 'Current release: **V71**' in readme)
check('README title V71','# CineBooking Pro V71' in readme)
...
check('README preserves real-data policy','V52/V65/V66/V67/V68/V69/V70/V71 **không tạo phim/khách/booking/payment giả**' in readme)
