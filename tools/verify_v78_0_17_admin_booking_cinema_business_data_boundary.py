...
ok(any(x in sw for x in ['const VERSION = "v78-0-17";','const VERSION = "v78-0-18";']), 'Service Worker generation is V78.0.17 or forward-compatible V78.0.18')
ok(any(x in v78page for x in ['>V78.0.17</span>','>V78.0.18</span>']), 'Visible V78 Admin surface reports V78.0.17 or forward-compatible V78.0.18')
...
ok(any(x in readme for x in ['Current release:** V78.0.17','Current release:** V78.0.18']) and '`v78.0.17`' in readme and 'Admin Booking Cinema Business-Data Boundary' in readme,
