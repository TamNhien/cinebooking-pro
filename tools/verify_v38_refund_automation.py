...
check('Main CI runs V38 verifier', 'python3 tools/verify_v38_refund_automation.py' in ci and re.search(r'V26-V(?:3[8-9]|[4-9]\d) source regression',ci) is not None)
