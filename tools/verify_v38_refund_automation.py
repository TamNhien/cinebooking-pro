...
check('Main CI runs V38 verifier', 'python3 tools/verify_v38_refund_automation.py' in ci and 'V26-V38 source regression' in ci)
check('Standalone RC defaults to V38 candidate', 'default: "v38.0.0-rc.1"' in rc and 'cinebooking_v38_rc_${{ github.run_id }}' in rc)
check('Standalone RC names V38 browser coverage', 'V37 + V38' in rc)
check('Stable release defaults to V38', 'default: "38.0.0"' in release and 'cinebooking_v38_release_${{ github.run_id }}' in release)
