-- CineBooking realistic reference-data seed/repair for the 50 tables shown in pgAdmin (V47 schema).
...
-- Quick verification of all 50 tables shown in pgAdmin V47.
DO $$
DECLARE
    t TEXT;
    c BIGINT;
