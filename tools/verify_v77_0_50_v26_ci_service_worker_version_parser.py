...
ok(any(x in sw for x in ['const VERSION = "v77-0-50";','const VERSION = "v77-0-52";']),
...
ok(any(x in readme for x in ['Current release:** V77.0.50','Current release:** V77.0.52']) and any(x in readme for x in ['`v77.0.50`','`v77.0.52`']),
...
ok(any(x in prev for x in ['v77-0-50','v77-0-52']) and 'V77.0.50' in prev,
