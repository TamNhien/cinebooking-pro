...
check('Testcontainers expects Flyway V36', 'isEqualTo("36")' in it and 'transferColumns' in it)
...
check('main CI runs V36 verifier', 'python3 tools/verify_v36_ticket_transfer.py' in ci and 'V26-V36 source regression' in ci)
check('standalone RC defaults to V36 semantic candidate', 'default: "v36.0.0-rc.1"' in rc)
check('standalone RC label includes V36 browser journey', 'V29.2 + V30 + V31.2 + V33 + V34 + V36' in rc)
check('stable release defaults to V36', 'default: "36.0.0"' in release and 'cinebooking_v36_release_${{ github.run_id }}' in release)
