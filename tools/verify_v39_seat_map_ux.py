...
check('Main CI runs V39 verifier in V39-or-newer regression', 'python3 tools/verify_v39_seat_map_ux.py' in ci and re.search(r'V26-V(?:39|[4-9]\d) source regression',ci) is not None)
rc_version=re.search(r'default: "v(\d+)\.0\.0-rc\.1"',rc)
...
stable_version=re.search(r'default: "(\d+)\.0\.0"',release)
