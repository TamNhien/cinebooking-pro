...
ok('const VERSION = "v77-0-52";' in sw,
   'Service Worker release metadata advances to V77.0.52')
...
ok('Current release:** V77.0.52' in readme and '`v77.0.52`' in readme,
   'README records V77.0.52 as the stable target')
...
ok('v77-0-52' in prev and 'V77.0.52' in prev,
   'V77.0.51 verifier is forward-compatible with V77.0.52 release metadata')
