...
Write-Host ""
Write-Host "=== V30.2 Playwright pin policy ==="
python .\tools\verify_v30_2_playwright_pin_policy.py
if($LASTEXITCODE -ne 0){ throw "V30.2 Playwright pin-policy verifier failed" }
...
Write-Host ""
Write-Host "V30.2 DIAGNOSTICS PASSED"
