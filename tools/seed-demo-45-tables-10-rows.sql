-- CineBooking demo seed/repair for the 45 tables shown in pgAdmin (V44 schema).
-- Adds/repairs 10 deterministic demo rows in the application tables, EXCEPT movie.
...
-- -----------------------------------------------------------------------------
-- 45. flyway_schema_history
-- DO NOT INSERT FAKE ROWS HERE. This table is Flyway's source of truth and already
-- contains real migration history. Faking 10 rows can break future migrations.
-- -----------------------------------------------------------------------------
DO $$
DECLARE
    flyway_rows BIGINT;
...
-- Quick verification of the 45 tables shown in pgAdmin.
DO $$
DECLARE
    t TEXT;
    c BIGINT;
