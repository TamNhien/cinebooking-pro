...
ok('const VERSION = "v78-0-18";' in sw, 'Service Worker generation advances to V78.0.18')
ok('>V78.0.18</span>' in v78page, 'Visible V78 Admin surface reports V78.0.18')
...
ok('Current release:** V78.0.18' in readme and '`v78.0.18`' in readme and 'Full-Suite Operational Read Stability' in readme,
