...
check('RC is V33-compatible or newer and identifies V33 browser coverage',bool(re.search(r'default: \"v(?:3[3-9]|[4-9][0-9])(?:\.\d+)*-rc(?:\.\d+|\d+)\"',rc)) and 'V29.2 + V30 + V31.2 + V33' in rc)
