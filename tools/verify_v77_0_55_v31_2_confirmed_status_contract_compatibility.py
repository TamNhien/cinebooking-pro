...
ok('aria-label={`Trạng thái đặt vé: ${viLabel(b.status)}`}' in bookings,
...
ok(any(x in sw for x in ['const VERSION = "v77-0-55";','const VERSION = "v77-0-56";','const VERSION = "v77-0-57";','const VERSION = "v77-0-59";','const VERSION = "v77-0-60";','const VERSION = "v77-0-61";']),
