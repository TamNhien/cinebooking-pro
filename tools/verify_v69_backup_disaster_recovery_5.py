...
check('step-up protected group count raised to nine or later',any(x in stepup_service for x in ['PROTECTED_ACTION_GROUPS=9','PROTECTED_ACTION_GROUPS=10','PROTECTED_ACTION_GROUPS=11','PROTECTED_ACTION_GROUPS=12']))
...
check('Integration expects Flyway >=69',any(x in itest for x in ['isGreaterThanOrEqualTo(69)','isGreaterThanOrEqualTo(70)','isGreaterThanOrEqualTo(71)','isGreaterThanOrEqualTo(72)']))
check('Integration expects at least 61 public tables',any(x in itest for x in ['publicTables).isGreaterThanOrEqualTo(61)','publicTables).isGreaterThanOrEqualTo(63)','publicTables).isGreaterThanOrEqualTo(65)','publicTables).isGreaterThanOrEqualTo(67)']))
