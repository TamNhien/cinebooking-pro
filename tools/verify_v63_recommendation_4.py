...
check('Admin Dashboard exposes Recommendation V63 tile', 'Recommendation V63' in admin and 'data-testid="admin-recommendation-v63"' in admin)
check('Admin V63 tile opens the existing For You experience', 'href="/for-you"' in admin and 'admin-recommendation-v63' in admin)
...
check('README current release is V63 or later', bool(current_match) and int(current_match.group(1))>=63 and '## V63 - Recommendation 4.0' in readme)
