...
ok("Integration test retains V46 schema coverage on current Flyway",has("backend/src/test/java/com/cinebooking/integration/CineBookingIntegrationIT.java","isEqualTo(\"47\")","trusted_device","security_alert","idx_security_alert_unacknowledged"))
...
ok("Main CI retains V46 verifier in V47 regression",has(".github/workflows/ci.yml","V26-V47 source regression","verify_v46_security_account_protection.py","verify_seed_demo_49.py"))
ok("Standalone RC retains V46 verifier in V47 gate",has(".github/workflows/release-candidate.yml","v47.0.0-rc.1","Verify V47 source gate","verify_v46_security_account_protection.py"))
ok("Stable release retains V46 verifier in V47 gate",has(".github/workflows/release.yml","default: \"47.0.0\"","Verify V47 source gate","verify_v46_security_account_protection.py"))
