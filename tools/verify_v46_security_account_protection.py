...
ok("Main CI retains V46 verifier in current regression",has(".github/workflows/ci.yml","verify_v46_security_account_protection.py") and (has(".github/workflows/ci.yml","V26-V47 source regression") or has(".github/workflows/ci.yml","V26-V48 source regression")))
ok("Standalone RC retains V46 verifier in current gate",has(".github/workflows/release-candidate.yml","verify_v46_security_account_protection.py") and (has(".github/workflows/release-candidate.yml","Verify V47 source gate") or has(".github/workflows/release-candidate.yml","Verify V48 source gate")))
ok("Stable release retains V46 verifier in current gate",has(".github/workflows/release.yml","verify_v46_security_account_protection.py") and ((has(".github/workflows/release.yml","default: \"47.0.0\"") and has(".github/workflows/release.yml","Verify V47 source gate")) or (has(".github/workflows/release.yml","default: \"48.0.0\"") and has(".github/workflows/release.yml","Verify V48 source gate"))))
