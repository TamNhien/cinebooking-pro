...
ok(any(x in sw for x in ['const VERSION = "v77-0-47";','const VERSION = "v77-0-48";','const VERSION = "v77-0-49";']),
...
ok(any(x in readme for x in ['Current release:** V77.0.47','Current release:** V77.0.48','Current release:** V77.0.49']) and any(x in readme for x in ['`v77.0.47`','`v77.0.48`','`v77.0.49`']),
   'README retains V77.0.47 history under the V77.0.49-or-newer stable target')
