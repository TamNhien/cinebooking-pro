-- CineBooking realistic reference-data seed/repair for the 52 tables shown in pgAdmin (V48 schema).
-- Adds/repairs realistic deterministic rows in every V48 application table, EXCEPT movie.
...
-- Quick verification of all 52 tables shown in pgAdmin V48.
DO $$
DECLARE
    t TEXT;
    c BIGINT;
