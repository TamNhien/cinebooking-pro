...
# integration/data
check('Integration expects Flyway >=68','isGreaterThanOrEqualTo(68)' in itest)
check('Integration expects at least 59 public tables','publicTables).isGreaterThanOrEqualTo(59)' in itest)
...
check('V67 verifier forward-compatible with Flyway V68','isGreaterThanOrEqualTo(68)' in v67verify)
check('V67 verifier forward-compatible with 59 tables','isGreaterThanOrEqualTo(59)' in v67verify)
check('V66 verifier forward-compatible with Flyway V68','isGreaterThanOrEqualTo(68)' in v66verify)
check('V66 verifier forward-compatible with 59 tables','isGreaterThanOrEqualTo(59)' in v66verify)
check('V68 adds no synthetic seed rows','V68' not in seed)

# CI/diagnose/release
check('CI source regression names V68','V26-V68 source regression' in ci)
...
# docs
check('README current release is V68','Current release:** V68' in readme or 'Current release: **V68**' in readme)
check('README title is V68','# CineBooking Pro V68' in readme)
