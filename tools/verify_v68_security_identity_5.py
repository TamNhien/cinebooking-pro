...
# integration/data
check('Integration expects Flyway >=68',any(x in itest for x in ['isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)','isGreaterThanOrEqualTo(70)','isGreaterThanOrEqualTo(71)','isGreaterThanOrEqualTo(72)']))
check('Integration expects at least 59 public tables',any(x in itest for x in ['publicTables).isGreaterThanOrEqualTo(59)','publicTables).isGreaterThanOrEqualTo(61)','publicTables).isGreaterThanOrEqualTo(63)','publicTables).isGreaterThanOrEqualTo(65)','publicTables).isGreaterThanOrEqualTo(67)']))
...
check('V67 verifier forward-compatible with Flyway V68',any(x in v67verify for x in ['isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)','isGreaterThanOrEqualTo(70)','isGreaterThanOrEqualTo(71)','isGreaterThanOrEqualTo(72)']))
...
check('V66 verifier forward-compatible with Flyway V68',any(x in v66verify for x in ['isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)','isGreaterThanOrEqualTo(70)','isGreaterThanOrEqualTo(71)','isGreaterThanOrEqualTo(72)']))
