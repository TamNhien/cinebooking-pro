...
# integration/data
check('Integration expects Flyway >=68',any(x in itest for x in ['isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)']))
check('Integration expects at least 59 public tables',any(x in itest for x in ['publicTables).isGreaterThanOrEqualTo(59)','publicTables).isGreaterThanOrEqualTo(61)']))
...
check('V67 verifier forward-compatible with Flyway V68',any(x in v67verify for x in ['isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)']))
...
check('V66 verifier forward-compatible with Flyway V68',any(x in v66verify for x in ['isGreaterThanOrEqualTo(68)','isGreaterThanOrEqualTo(69)']))
...
# CI/diagnose/release
check('CI source regression names V68 or later',any(x in ci for x in ['V26-V68 source regression','V26-V69 source regression']))
...
# docs
check('README current release is V68 or later',any(x in readme for x in ['Current release:** V68','Current release: **V68**','Current release:** V69','Current release: **V69**']))
check('README title is V68 or later',any(x in readme for x in ['# CineBooking Pro V68','# CineBooking Pro V69']))
