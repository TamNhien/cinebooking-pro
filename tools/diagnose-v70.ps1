...
Write-Host '=== CineBooking V70 Data Governance & Privacy 5.0 ===' -ForegroundColor Cyan
Write-Host 'Expected runtime: Flyway V70, at least 63 public tables.' -ForegroundColor DarkCyan
...
Write-Host "`nPASS: V70 source gates completed." -ForegroundColor Green
Write-Host 'Runtime next: docker compose -f docker-compose.yml -f docker-compose.https.yml up -d --build'
Write-Host 'Browser E2E: cd frontend; npx playwright test "e2e/data-governance-privacy-v70.spec.ts" --project=chromium'
