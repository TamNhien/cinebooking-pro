...
ok(any(x in sw for x in ['const VERSION = "v77-0-60";','const VERSION = "v77-0-61";']),'Service Worker release metadata advances to V77.0.60 or a forward-compatible patch')
