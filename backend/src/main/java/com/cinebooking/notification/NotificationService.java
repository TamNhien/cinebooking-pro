...
public class NotificationService {
    ...
    private String priority(String type){String t=type==null?"":type.toUpperCase(Locale.ROOT);if(t.startsWith("WAITLIST")||t.startsWith("REFUND_REVIEW")||t.startsWith("PAYMENT_REVIEW")||t.startsWith("SHOWTIME_REMINDER_30M"))return "HIGH";if(t.startsWith("PROMOTION"))return "LOW";return "NORMAL";}
