...
public class NotificationController {
    ...
    @GetMapping public List<NotificationResponse> list(@RequestParam(defaultValue="ACTIVE") String view,Authentication a){return s.list(a.getName(),view);}
    ...
    @PostMapping("/{id}/archive") public NotificationResponse archive(@PathVariable UUID id,Authentication a){return s.archive(id,a.getName());}
    @PostMapping("/{id}/unarchive") public NotificationResponse unarchive(@PathVariable UUID id,Authentication a){return s.unarchive(id,a.getName());}
