...
public final class AdminPaymentDtos {
    ...
    public record WebhookAdminView(UUID id,String provider,String eventKey,UUID paymentId,String payloadHash,boolean signatureValid,String resultCode,String responseCode,String responseMessage,Instant receivedAt,Instant processedAt,String deliveryState,int recoveryAttempts,Instant lastRecoveryAt,Instant recoveredAt,String recoveryMessage){}
