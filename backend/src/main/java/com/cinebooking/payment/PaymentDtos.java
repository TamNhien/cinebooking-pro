...
public final class PaymentDtos {
    ...
    public record PaymentHistoryItem(UUID paymentId, UUID bookingId, UUID payerUserId, String movieTitle, String provider, String status, BigDecimal amount, String providerOrderId, String providerTransactionId, String providerResponseCode, String providerMessage, Instant createdAt, Instant updatedAt, Instant expiresAt, Instant paidAt, Instant failedAt) {}
