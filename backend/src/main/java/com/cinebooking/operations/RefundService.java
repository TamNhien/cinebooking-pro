...
public class RefundService {
    ...
    @Transactional public RefundView approve(UUID bookingId,String adminEmail,String ip){
        ...
        AppUser user=users.findByIdForUpdate(b.getUserId()).orElseThrow(); Payment p=payments.findFirstByBookingIdOrderByCreatedAtDesc(b.getId()).orElseThrow(()->new ApiException(HttpStatus.CONFLICT,"Không tìm thấy giao dịch thanh toán"));
