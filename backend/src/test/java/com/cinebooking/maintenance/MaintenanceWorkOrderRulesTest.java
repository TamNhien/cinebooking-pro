...
class MaintenanceWorkOrderRulesTest {
    ...
    @Test void twoCharacterResultIsAcceptedForCompletion() {
        assertThat(MaintenanceWorkOrderRules.requiresNote("RESOLVED")).isTrue();
        assertThat(MaintenanceWorkOrderRules.validTransitionNote("RESOLVED", "ok")).isTrue();
        assertThat(MaintenanceWorkOrderRules.validTransitionNote("RESOLVED", " O ")).isFalse();
        assertThat(MaintenanceWorkOrderRules.validTransitionNote("RESOLVED", "  ")).isFalse();
        assertThat(MaintenanceWorkOrderRules.validTransitionNote("IN_PROGRESS", null)).isTrue();
    }
}
