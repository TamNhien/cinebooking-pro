...
export default function Header() {
    ...
    const drawer = mounted && open ? createPortal(_jsx("div", { className: "menu-drawer-backdrop", role: "presentation", onMouseDown: (e) => { if (e.target === e.currentTarget)
            close(); }, children: _jsxs("aside", { id: "cinebooking-navigation-drawer", className: "menu-drawer", role: "dialog", "aria-modal": "true", "aria-label": en ? "Navigation menu" : "Menu điều hướng", children: [_jsxs("div", { className: "menu-drawer-head", children: [_jsxs("div", { children: [_jsx("p", { className: "menu-drawer-kicker", children: "CineBooking Pro" }), _jsx("h2", { children: en ? "Navigation" : "Menu" })] }), _jsx("button", { type: "button", className: "menu-drawer-close", onClick: close, "aria-label": en ? "Close menu" : "Đóng menu", children: "\u2715" })] }), auth && _jsxs("div", { className: "menu-drawer-user", children: [_jsxs("div", { className: "min-w-0", children: [_jsx("b", { className: "block truncate", children: auth.fullName || auth.email }), _jsx("span", { children: auth.role })] }), unread > 0 && _jsxs(Link, { onClick: close, href: "/notifications", className: "menu-drawer-badge", children: ["\uD83D\uDD14 ", unread > 99 ? "99+" : unread] })] }), _jsxs("nav", { className: "menu-drawer-nav", children: [_jsxs("div", { className: `menu-drawer-section-card ${drawerSection === "explore" ? "is-open" : ""}`, children: [sectionButton("explore", en ? "Explore" : "Khám phá", "🧭"), drawerSection === "explore" && _jsxs("div", { className: "menu-drawer-submenu", children: [_jsxs(Link, { onClick: close, href: "/movies", children: ["\uD83C\uDFAC ", en ? "Movies" : "Phim"] }), _jsxs(Link, { onClick: close, href: "/cinemas", children: ["\uD83C\uDFE2 ", en ? "Cinemas & showtimes" : "Rạp & lịch chiếu"] }), _jsxs(Link, { onClick: close, href: "/promotions", children: ["\uD83C\uDF81 ", en ? "Promotions" : "Ưu đãi"] })] })] }), auth && _jsxs("div", { className: `menu-drawer-section-card ${drawerSection === "account" ? "is-open" : ""}`, children: [sectionButton("account", en ? "My account" : "Tài khoản", "👤"), drawerSection === "account" && _jsxs("div", { className: "menu-drawer-submenu", children: [_jsxs(Link, { onClick: close, href: "/bookings", children: ["\uD83C\uDF9F ", en ? "My tickets" : "Vé của tôi"] }), _jsxs(Link, { onClick: close, href: "/payments", children: ["\uD83D\uDCB3 ", en ? "Payments" : "Thanh toán"] }), _jsxs(Link, { onClick: close, href: "/favorites", children: ["\u2764\uFE0F ", en ? "Favorites" : "Yêu thích"] }), _jsxs(Link, { onClick: close, href: "/for-you", children: ["\uD83C\uDFAF ", en ? "For you" : "Gu phim"] }), _jsxs(Link, { onClick: close, href: "/waitlist", children: ["\uD83D\uDD14 ", en ? "Seat alerts" : "Chờ ghế trống"] }), _jsxs(Link, { onClick: close, href: "/profile", children: ["\uD83D\uDC64 ", en ? "Account" : "Tài khoản"] }), _jsxs(Link, { onClick: close, href: "/security", children: ["\uD83D\uDEE1 ", en ? "Security" : "Bảo mật"] }), _jsxs(Link, { onClick: close, href: "/notifications", children: ["\uD83D\uDD14 ", en ? "Notifications" : "Thông báo", unread > 0 ? ` (${unread})` : ""] }), _jsxs(Link, { onClick: close, href: "/support", children: ["\uD83C\uDFA7 ", en ? "Support" : "Hỗ trợ"] })] })] }), auth && ["STAFF", "MANAGER", "ADMIN"].includes(auth.role) && _jsxs("div", { className: `menu-drawer-section-card ${drawerSection === "operations" ? "is-open" : ""}`, children: [sectionButton("operations", en ? "Operations" : "Vận hành", "🎟"), drawerSection === "operations" && _jsxs("div", { className: "menu-drawer-submenu", children: [["STAFF", "MANAGER"].includes(auth.role) && _jsxs(Link, { onClick: close, href: "/staff/schedule", children: ["\uD83D\uDD52 ", en ? "Shift & attendance" : "Lịch & chấm công"] }), _jsxs(Link, { onClick: close, href: "/staff/check-in", children: ["\uD83D\uDCF7 ", en ? "Ticket check-in" : "Quét vé"] }), _jsxs(Link, { onClick: close, href: "/staff/operations", children: ["\uD83D\uDCE1 ", en ? "Live operations" : "Vận hành realtime"] })] })] }), auth?.role === "MANAGER" && _jsxs("div", { className: `menu-drawer-section-card ${drawerSection === "management" ? "is-open" : ""}`, children: [sectionButton("management", en ? "Management" : "Quản lý", "🧰"), drawerSection === "management" && _jsxs("div", { className: "menu-drawer-submenu", children: [_jsxs(Link, { onClick: close, href: "/admin/shifts", children: ["\uD83D\uDDD3 ", en ? "Shift scheduling" : "Xếp ca"] }), _jsxs(Link, { onClick: close, href: "/admin/attendance", children: ["\uD83E\uDDFE ", en ? "Timesheet & leave" : "Bảng công & nghỉ phép"] }), _jsx(Link, { onClick: close, href: "/admin/analytics", children: "\uD83D\uDCCA Analytics" }), _jsx(Link, { onClick: close, href: "/admin/maintenance", children: "\uD83D\uDEE0 B\u1EA3o tr\u00EC & thi\u1EBFt b\u1ECB" }), _jsx(Link, { onClick: close, href: "/admin/support", children: "\uD83C\uDFA7 H\u1ED7 tr\u1EE3 kh\u00E1ch h\u00E0ng" })] })] }), auth?.role === "ADMIN" && _jsxs("div", { className: `menu-drawer-section-card ${drawerSection === "admin" ? "is-open" : ""}`, children: [sectionButton("admin", en ? "Administration" : "Quản trị", "⚙️"), drawerSection === "admin" && _jsxs("div", { className: "menu-drawer-submenu", children: [_jsx(Link, { onClick: close, href: "/admin", children: "\uD83E\uDDED Dashboard" }), _jsx(Link, { onClick: close, href: "/admin/bookings", children: "\uD83C\uDFAB Booking" }), _jsx(Link, { onClick: close, href: "/admin/payments", children: "\uD83D\uDCB3 Payment Ops" }), _jsxs(Link, { onClick: close, href: "/admin/staff", children: ["\uD83D\uDC68\u200D\uD83D\uDCBC ", en ? "Staff accounts" : "Nhân viên"] }), _jsxs(Link, { onClick: close, href: "/admin/shifts", children: ["\uD83D\uDD52 ", en ? "Shift scheduling" : "Xếp ca"] }), _jsxs(Link, { onClick: close, href: "/admin/attendance", children: ["\uD83E\uDDFE ", en ? "Timesheet & leave" : "Bảng công & nghỉ phép"] }), _jsxs(Link, { onClick: close, href: "/admin/vouchers", children: ["\uD83C\uDF9F ", en ? "Vouchers" : "Mã ưu đãi"] }), _jsxs(Link, { onClick: close, href: "/admin/loyalty", children: ["\uD83C\uDFC6 ", en ? "Loyalty" : "Thành viên"] }), _jsxs(Link, { onClick: close, href: "/admin/pricing", children: ["\uD83D\uDCB0 ", en ? "Dynamic pricing" : "Giá vé động"] }), _jsxs(Link, { onClick: close, href: "/admin/commerce", children: ["\uD83C\uDF7F ", en ? "Food & commerce" : "Bắp nước & thương mại"] }), _jsxs(Link, { onClick: close, href: "/admin/inventory", children: ["\uD83D\uDCE6 ", en ? "Inventory" : "Kho bắp nước"] }), _jsxs(Link, { onClick: close, href: "/admin/reviews", children: ["\u2B50 ", en ? "Review moderation" : "Kiểm duyệt đánh giá"] }), _jsx(Link, { onClick: close, href: "/admin/analytics", children: "\uD83D\uDCC8 Analytics" }), _jsxs(Link, { onClick: close, href: "/admin/maintenance", children: ["\uD83D\uDEE0 ", en ? "Maintenance & assets" : "Bảo trì & thiết bị"] }), _jsxs(Link, { onClick: close, href: "/admin/support", children: ["\uD83C\uDFA7 ", en ? "Customer support" : "Hỗ trợ khách hàng"] }), _jsxs(Link, { onClick: close, href: "/admin/security", children: ["\uD83D\uDEE1 ", en ? "Security operations" : "Security Operations"] }), _jsxs(Link, { onClick: close, href: "/admin/refunds", children: ["\u21A9 ", en ? "Refunds" : "Hoàn vé"] }), _jsx(Link, { onClick: close, href: "/admin/audit", children: "\uD83D\uDEE1 Audit log" })] })] })] }), !auth && _jsx("div", { className: "menu-drawer-footer", children: _jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsx(Link, { onClick: close, className: "btn btn-secondary", href: "/register", children: en ? "Register" : "Đăng ký" }), _jsx(Link, { onClick: close, className: "btn btn-primary", href: "/login", children: en ? "Sign in" : "Đăng nhập" })] }) })] }) }), document.body) : null;
    return _jsxs(_Fragment, { children: [_jsx("header", { className: "sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl", children: _jsxs("div", { className: "mx-auto flex max-w-[1500px] items-center gap-4 px-4 py-3 md:px-6", children: [_jsxs(Link, { href: "/", className: "shrink-0 whitespace-nowrap text-lg font-bold tracking-tight 2xl:text-xl", children: ["\uD83C\uDFAC CineBooking ", _jsx("span", { className: "text-rose-500", children: "Pro" })] }), _jsxs("nav", { className: "hidden min-w-0 flex-1 items-center justify-center gap-4 whitespace-nowrap text-[13px] font-semibold xl:flex 2xl:gap-5 2xl:text-sm", children: [_jsx(Link, { href: "/movies", className: "nav-link", children: en ? "Movies" : "Phim" }), _jsx(Link, { href: "/cinemas", className: "nav-link", children: en ? "Cinemas & showtimes" : "Rạp & lịch chiếu" }), _jsx(Link, { href: "/promotions", className: "nav-link", children: en ? "Promotions" : "Ưu đãi" }), auth && _jsx(Link, { href: "/bookings", className: "nav-link", children: en ? "My tickets" : "Vé của tôi" }), auth && _jsx(Link, { href: "/payments", className: "nav-link", children: en ? "Payments" : "Thanh toán" }), auth && _jsx(Link, { href: "/favorites", className: "nav-link", children: en ? "Favorites" : "Yêu thích" }), auth && _jsx(Link, { href: "/for-you", className: "nav-link", children: en ? "For you" : "Gu phim" }), auth && _jsx(Link, { href: "/waitlist", className: "nav-link", children: en ? "Seat alerts" : "Chờ ghế" }), auth && _jsx(Link, { href: "/profile", className: "nav-link", children: en ? "Account" : "Tài khoản" }), auth && _jsx(Link, { href: "/security", className: "nav-link", children: en ? "Security" : "Bảo mật" }), auth && _jsx(Link, { href: "/support", className: "nav-link", children: en ? "Support" : "Hỗ trợ" }), auth && ["STAFF", "MANAGER"].includes(auth.role) && _jsx(Link, { href: "/staff/schedule", className: "nav-link", children: "Ca l\u00E0m" }), auth && ["STAFF", "MANAGER", "ADMIN"].includes(auth.role) && _jsx(Link, { href: "/staff/check-in", className: "nav-link", children: "Check-in" }), auth && ["STAFF", "MANAGER", "ADMIN"].includes(auth.role) && _jsx(Link, { href: "/staff/operations", className: "nav-link", children: "V\u1EADn h\u00E0nh" }), auth?.role === "MANAGER" && _jsxs("div", { className: "nav-menu relative", "data-desktop-menu-root": "true", children: [_jsxs("button", { type: "button", className: `nav-link nav-menu-button ${desktopMenu === "manager" ? "is-open" : ""}`, onClick: () => toggleDesktop("manager"), "aria-expanded": desktopMenu === "manager", children: ["Qu\u1EA3n l\u00FD ", _jsx("span", { "aria-hidden": "true", children: "\u2304" })] }), desktopMenu === "manager" && _jsxs("div", { className: "nav-menu-panel", children: [_jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/shifts", children: "X\u1EBFp ca" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/attendance", children: "B\u1EA3ng c\u00F4ng & ngh\u1EC9 ph\u00E9p" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/staff/operations", children: "V\u1EADn h\u00E0nh realtime" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/analytics", children: "Analytics" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/maintenance", children: "B\u1EA3o tr\u00EC & thi\u1EBFt b\u1ECB" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/support", children: "H\u1ED7 tr\u1EE3 kh\u00E1ch h\u00E0ng" })] })] }), auth?.role === "ADMIN" && _jsxs(_Fragment, { children: [_jsx(Link, { href: "/admin/bookings", className: "nav-link", children: "Booking" }), _jsxs("div", { className: "nav-menu relative", "data-desktop-menu-root": "true", children: [_jsxs("button", { type: "button", className: `nav-link nav-menu-button ${desktopMenu === "admin" ? "is-open" : ""}`, onClick: () => toggleDesktop("admin"), "aria-expanded": desktopMenu === "admin", children: ["Qu\u1EA3n tr\u1ECB ", _jsx("span", { "aria-hidden": "true", children: "\u2304" })] }), desktopMenu === "admin" && _jsxs("div", { className: "nav-menu-panel", children: [_jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin", children: "Dashboard" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/payments", children: "Payment Ops" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/staff", children: "Nh\u00E2n vi\u00EAn" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/shifts", children: "X\u1EBFp ca" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/attendance", children: "B\u1EA3ng c\u00F4ng & ngh\u1EC9 ph\u00E9p" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/staff/operations", children: "V\u1EADn h\u00E0nh realtime" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/vouchers", children: "M\u00E3 \u01B0u \u0111\u00E3i" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/loyalty", children: "Loyalty & th\u00E0nh vi\u00EAn" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/pricing", children: "Gi\u00E1 v\u00E9 \u0111\u1ED9ng" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/commerce", children: "B\u1EAFp n\u01B0\u1EDBc & th\u01B0\u01A1ng m\u1EA1i" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/inventory", children: "Kho b\u1EAFp n\u01B0\u1EDBc" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/reviews", children: "Ki\u1EC3m duy\u1EC7t \u0111\u00E1nh gi\u00E1" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/analytics", children: "Analytics" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/maintenance", children: "B\u1EA3o tr\u00EC & thi\u1EBFt b\u1ECB" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/support", children: "H\u1ED7 tr\u1EE3 kh\u00E1ch h\u00E0ng" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/security", children: "Security Operations" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/refunds", children: "Ho\u00E0n v\u00E9" }), _jsx(Link, { onClick: () => setDesktopMenu(null), href: "/admin/audit", children: "Audit log" })] })] })] })] }), _jsxs("div", { className: "ml-auto flex shrink-0 items-center gap-2", children: [_jsx(LanguageSwitcher, {}), auth && notify, auth ? _jsxs(_Fragment, { children: [_jsx("span", { className: "hidden max-w-28 truncate text-sm text-slate-400 2xl:inline", title: auth.fullName, children: auth.fullName }), _jsx("button", { type: "button", className: "btn btn-secondary hidden whitespace-nowrap !px-3 !py-2 sm:inline-flex", onClick: logout, children: en ? "Sign out" : "Đăng xuất" })] }) : _jsxs(_Fragment, { children: [_jsx(Link, { className: "hidden whitespace-nowrap text-sm font-semibold sm:block", href: "/register", children: en ? "Register" : "Đăng ký" }), _jsx(Link, { className: "btn btn-primary hidden whitespace-nowrap !px-3 !py-2 sm:inline-flex", href: "/login", children: en ? "Sign in" : "Đăng nhập" })] }), _jsx("button", { type: "button", className: `menu-trigger ${open ? "is-open" : ""}`, onClick: () => { setOpen(v => !v); setDrawerSection(null); setDesktopMenu(null); }, "aria-label": open ? (en ? "Close menu" : "Đóng menu") : (en ? "Open menu" : "Mở menu"), "aria-expanded": open, "aria-controls": "cinebooking-navigation-drawer", children: open ? "✕" : "☰" })] })] }) }), drawer] });
}
