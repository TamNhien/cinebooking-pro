  ...
  return (
    <div className="mx-auto max-w-md card p-7">
      ...
      <form onSubmit={submit} className="mt-6 space-y-4">
        <input data-testid="login-email" className="input" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Email" autoComplete="email" required />
        <PasswordInput data-testid="login-password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Mật khẩu" autoComplete="current-password" required />
