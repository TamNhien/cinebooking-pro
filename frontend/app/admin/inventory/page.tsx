...
export default function InventoryAdmin(){
  ...
  return <div className="space-y-7" data-testid="inventory-v48">
    <div className="flex flex-wrap items-end justify-between gap-4">
      <div><p className="section-kicker">KHO · V48</p><h1 className="text-3xl font-black">Kho bắp nước theo rạp</h1><p className="mt-1 text-slate-400">Tồn kho, giá bán, hao hụt và điều chuyển được quản lý riêng cho từng chi nhánh.</p></div>
      <div className="flex flex-wrap gap-2"><Link className="btn btn-secondary" href="/admin/commerce">🍿 Danh mục sản phẩm</Link><Link className="btn btn-secondary" href="/admin">← Quản trị</Link></div>
    </div>
