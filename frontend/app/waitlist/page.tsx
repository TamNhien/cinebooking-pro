...
export default function WaitlistPage(){
  ...
  return <div className="mx-auto max-w-5xl space-y-8">
    <div><p className="section-kicker">V32 · CẢNH BÁO GHẾ</p><h1 className="text-3xl font-bold">Danh sách chờ suất chiếu</h1><p className="mt-2 text-slate-400">Theo dõi các suất đang hết ghế. CineBooking sẽ báo khi có ghế được mở lại do huỷ đơn, hết hạn giữ ghế hoặc hoàn vé.</p></div>
