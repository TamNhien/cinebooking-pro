...
export default function StaffOperationsPage(){
  ...
  return <div className="mx-auto max-w-7xl space-y-7">
    <div className="flex flex-wrap items-end justify-between gap-3"><div><p className="section-kicker">VẬN HÀNH NHÂN VIÊN 2.0 · V43</p><h1 className="text-3xl font-bold">Trung tâm vận hành rạp thời gian thực</h1><p className="mt-2 text-slate-400">Theo dõi lượt khách vào rạp, bàn giao ca và xử lý sự cố trên cùng một màn hình.</p></div><div className="flex gap-2"><Link href="/staff/check-in" className="btn btn-primary">📷 Quét vé</Link>{role!=="ADMIN"&&<Link href="/staff/schedule" className="btn btn-secondary">🕒 Ca làm</Link>}</div></div>
