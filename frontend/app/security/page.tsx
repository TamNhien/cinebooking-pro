...
export default function SecurityCenter(){
  ...
  return <div className="mx-auto max-w-6xl space-y-6 px-4 py-8">
    <div><p className="section-kicker">V46 · BẢO MẬT & BẢO VỆ TÀI KHOẢN 2.0</p><h1 className="text-3xl font-black">Trung tâm bảo mật tài khoản</h1><p className="mt-2 text-slate-400">Theo dõi cảnh báo rủi ro, thiết bị tin cậy và phiên đăng nhập của tài khoản.</p></div>
