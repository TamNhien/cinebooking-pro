...
export default function BookingPage({params}:{params:Promise<{showtimeId:string}>}){
  ...
  return <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_380px]">
    ...
    <aside className="card h-fit p-6 lg:sticky lg:top-24">
      ...
      {held&&<div data-testid="seat-hold-authority-v66" className="mt-2 text-center text-[11px] font-semibold text-emerald-300">🛡 V66 · {map?.holdAuthority||"POSTGRESQL_WITH_REDIS_MIRROR"} · chống double-booking đa replica</div>}
