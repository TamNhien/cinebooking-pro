...
export type PaymentHistoryItem = { paymentId:string; bookingId:string; payerUserId:string; movieTitle:string; provider:string; status:string; amount:number; providerOrderId?:string; providerTransactionId?:string; providerResponseCode?:string; providerMessage?:string; createdAt:string; updatedAt:string; expiresAt?:string; paidAt?:string; failedAt?:string };
